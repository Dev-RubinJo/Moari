...
open class CameraViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        self.containerSwapLibraryButton.isHidden = true
    }
    ...
    private func setupActions() {
        ...
        // 현재 제대로 작동을 안해서 버튼에 addTarget으로 메서드 지정
        cameraButton.addTarget(self, action: #selector(self.capturePhoto), for: .touchUpInside)
     ...
     */
    @objc internal func capturePhoto() {
